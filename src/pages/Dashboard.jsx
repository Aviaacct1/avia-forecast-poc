...
export default function Dashboard({ onBack }) {
      ...
      <div className="min-h-screen bg-slate-50">
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="bg-white rounded-lg shadow border border-slate-200 p-6">
            <h3 className="text-lg font-bold mb-6">Passenger Forecast Chart</h3>
  ...
  if (view === 'regional' && selectedRegion) {
    ...
    const chartData = Object.entries(countries).sort((a, b) => b[1][2044] - a[1][2044]).map(([country, data]) => ({
      name: country,
      2024: data[2024] / 1e9,
      2030: data[2030] / 1e9,
      2044: data[2044] / 1e9,
  ...
  if (view === 'country' && selectedCountry && selectedRegion) {
    ...
    const chartData = countryAirports.map((airport) => ({
      code: airport.code,
      2024: (airport.forecasts['2024']?.pax || 0) / 1e6,
      2030: (airport.forecasts['2030']?.pax || 0) / 1e6,
      2044: (airport.forecasts['2044']?.pax || 0) / 1e6,
    }));
              ...
              <tbody className="divide-y">
                {countryAirports.map((airport) => (
                  <tr key={airport.code} className="hover:bg-blue-50">
                    <td className="px-6 py-3 font-semibold text-blue-600">{airport.co
